\begin{frame}{Auswertung}
    ...
    \note[item]{groesster Indikator fuer Erfolg ist Pop-groesse}
    \note[item]{Tests: Abhaengig von Schwierigkeit}
    \note[item]{40 Sudokus: leicht bis extrem}
    \note[item]{kleine Eingabegroesse, wenig Aussagekraft}
\end{frame}
\begin{frame}{Auswertung}
