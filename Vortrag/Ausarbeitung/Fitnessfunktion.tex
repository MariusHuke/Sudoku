\begin{frame}{Fitnessberechnung}
    \begin{columns}[T] % T aligns the tops of the columns
        ...
        \end{column}
    \end{columns}
    \note[item]{gelb: kollidierende Felder}
    \note[item]{Fitness-Sudoku: s. 1. Block}
    \note[item]{Kollisionszahl als Fitnesswert}
    \note[item]{0 als Idealwert --> geringere Werte besser}
\end{frame}
